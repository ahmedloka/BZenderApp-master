...
public class TenderCar
{
    ...
    {
        return "ClassPojo [FromKM = "+FromKM+", ViolationDocument = "+ViolationDocument+", RegistrationFees = "+RegistrationFees+", EngineCapacity = "+EngineCapacity+", NumberOfCar = "+NumberOfCar+", YearOfCar = "+YearOfCar+", CarModel = "+CarModel+", TenderId = "+TenderId+", TransmissionType = "+TransmissionType+", CarModelId = "+CarModelId+", Note = "+Note+", LicenseStatus = "+LicenseStatus+", CarType = "+CarType+", ToKM = "+ToKM+", Id = "+Id+", PossibilityOfExamination = "+PossibilityOfExamination+", CarTypeId = "+CarTypeId+"]";
    }
}
